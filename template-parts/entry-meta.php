...
<?php } else { ?>
	<span class="post__date"><?php the_time( get_option( 'date_format' ) ); ?></span><span class="post__meta-sep"> | </span><span class="post__date--updated"><?php _e( 'Updated: ', 'urban-square' ) ?><?php the_modified_time( get_option ( 'date_format') ); ?></span>
<?php } ?>
</section>